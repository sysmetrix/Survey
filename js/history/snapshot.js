...
export const SETTINGS_KEYS = ["orgName", "reportTitle", "date", "thresholds", "fontPreset", "fontBody", "fontHeading", "baseSize", "lineSpacing"];
...
export function diffEditable(older, newer) {
  ...
  const SET_LABEL = { orgName: "기관명", reportTitle: "보고서 제목", date: "작성일", thresholds: "판정 기준", fontPreset: "글꼴", fontBody: "본문 글꼴", fontHeading: "제목 글꼴", baseSize: "글자 크기", lineSpacing: "줄 간격" };
