...
const STEPS = [
  { view: "load", target: "[data-act='tutorial']", title: "처음 사용자를 위한 화면 가이드", text: "실제 화면을 따라가며 샘플 설문을 분석하고 한글 보고서까지 만드는 과정을 보여 드립니다. 샘플만 사용하므로 내 파일과 작업 내역은 바뀌지 않습니다." },
  { view: "load", target: "[data-drop='data']", title: "① 설문 파일 불러오기", text: "엑셀·CSV 파일을 이 자리에 끌어다 놓거나 눌러서 고르면 됩니다. 구글폼·네이버폼에서 내려받은 원본 파일도 그대로 쓸 수 있습니다." },
  ...
  { view: "setup", target: ".tblwrap", title: "문항 설정 확인", text: "문항 역할과 척도 범위, 역문항을 확인합니다. 문자로 된 보기는 보기별 점수를 정해 주면 숫자로 분석됩니다." },
  ...
  { view: "business", target: ".quick-kpis", title: "③ 성과지표는 선택 사항", text: "목표 달성 여부를 보고서에 넣고 싶을 때만 빠른 추가를 사용하세요. 단순 만족도 분석이라면 입력하지 않아도 됩니다." },
...
const stepMsOf = s => (s.run ? 3500 : 10000);
