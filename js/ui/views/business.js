...
const KPI_FIELDS = ["id", "name", "stage", "goalId", "metric", "targetRef", "target", "actual", "prevActual", "direction", "unit", "note", "targetBasis", "measurementTime", "requireTarget", "evaluationPurpose"];
function pickKpi(k) {
  const o = {};
