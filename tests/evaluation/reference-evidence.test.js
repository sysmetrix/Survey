...
import { REFERENCE_EVIDENCE, normalizeEvidenceRef, referenceEvidenceById } from "../../js/evaluation/reference-evidence.js";
...
test("연결된 근거는 분석 보고서에 ID·원칙·원문 URL로 추적된다", () => {
  ...
  const evaluation = { results:[{ id:"K1", name:"참여 경험", metric:"manual", stage:"산출", evidenceRef:ref.id }], summary:{ total:1, measured:0, achieved:0, mostly:0, notAchieved:0, unmeasured:1, unsetTarget:0, byStage:[] } };
  try {
