...
// ───── 3) 회고식 소표본 ─────
{
  ...
  XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet([
    ["구분", "항목", "내용", "비고"],
    ["사업개요", "사업명", "2026 청소년 참여위원회 운영", ""],
    ["사업개요", "사업기간", "2026. 1. ~ 2026. 12. (월 1회 정기회의 + 분기 활동)", ""],
    ["사업개요", "참여대상", "위촉 청소년 참여위원 24명", ""],
    ["사업개요", "사업예산", "5,000천원", ""],
    ["사업개요", "추진부서", "청소년참여팀", ""],
    ["사업개요", "추진배경", "정책 결정 과정에 청소년 의견을 반영할 통로와 청소년의 주도적 참여 경험이 부족함", ""],
    ["사업개요", "사업목적", "청소년이 지역 정책 논의에 직접 참여하며 협력·표현·도전 역량과 지역사회에 대한 관심을 기르도록 지원", ""],
    ["목표", "추진목표", "청소년 위원의 협력·표현·도전 역량 향상", ""],
    ["목표", "추진목표", "지역사회 관심 제고 및 참여 만족도 확보", ""],
    ["논리모형", "투입", "예산 5,000천원\n담당 촉진자 2명\n회의 공간 및 활동 자료", ""],
    ["논리모형", "활동", "월례 정기회의 12회\n정책 제안 워크숍 2회\n지역 현장 방문 2회", ""],
    ["논리모형", "산출", "참여위원 24명 위촉·운영\n정책 제안서 1건 제출", ""],
    ["논리모형", "단기성과", "표현하는 능력 향상\n도전하는 태도 향상\n참여 만족도 확보", ""],
    ["논리모형", "중기성과", "지역사회에 대한 관심 증가", ""],
    ["논리모형", "영향", "지역사회 문제에 주도적으로 참여하는 청소년 성장", ""],
  ]), "사업정보");
  XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet([
    ["지표ID", "지표명", "성과단계", "연계목표", "측정방법", "대상문항", "목표값", "실적값", "방향", "단위"],
    ["K1", "참여위원회 운영 횟수", "산출", "협력·표현·도전 역량 향상", "직접입력", "", 12, 12, "상향", "회"],
    ["K2", "참여 청소년 수(실인원)", "산출", "협력·표현·도전 역량 향상", "직접입력", "", 24, 24, "상향", "명"],
    ["K3", "도전하는 태도 향상도", "단기성과", "협력·표현·도전 역량 향상", "사전사후 변화량", "새로운 일에 도전하는 태도", 0.5, "", "상향", "점"],
    ["K4", "생각을 표현하는 능력 향상도", "단기성과", "협력·표현·도전 역량 향상", "사전사후 변화량", "내 생각을 표현하는 능력", 0.5, "", "상향", "점"],
...
// ───── 5) 단일 시트 사전·사후 (사전_/사후_ 접두어, 동일 응답자) ─────
{
  ...
  XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet([
    ["구분", "항목", "내용", "비고"],
    ["사업개요", "사업명", "2026 청소년 리더십 캠프", ""],
    ["사업개요", "사업기간", "2026. 7. ~ 2026. 8. (2박 3일 × 4기)", ""],
    ["사업개요", "참여대상", "관내 중·고등학생 64명", ""],
    ["사업개요", "사업예산", "8,000천원", ""],
    ["사업개요", "추진부서", "청소년지도팀", ""],
    ["사업개요", "추진배경", "또래 관계 속에서 자기주도성과 협업 역량을 기를 기회가 부족함", ""],
    ["사업개요", "사업목적", "팀 활동과 리더십 훈련을 통해 청소년의 자기효능감과 공동체 의식을 높인다", ""],
    ["목표", "추진목표", "자기효능감·문제해결력·의사소통 능력 향상", ""],
    ["목표", "추진목표", "공동체 의식 함양 및 참여 만족도 제고", ""],
    ["논리모형", "투입", "예산 8,000천원\n전담 지도자 4명\n야영장·수련시설", ""],
    ["논리모형", "활동", "팀빌딩 미션 활동 4회\n리더십 특강 2회\n조별 프로젝트 발표 1회", ""],
    ["논리모형", "산출", "캠프 4기 운영\n참여 청소년 64명\n수료율 100%", ""],
    ["논리모형", "단기성과", "자기효능감 향상\n문제해결력 향상\n의사소통 능력 향상", ""],
    ["논리모형", "중기성과", "공동체 의식 향상자 비율 증가", ""],
    ["논리모형", "영향", "자기주도적으로 협력하는 청소년 성장", ""],
  ]), "사업정보");
  XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet([
    ["지표ID", "지표명", "성과단계", "연계목표", "측정방법", "대상문항", "목표값", "실적값", "방향", "단위"],
    ["K1", "프로그램 운영 횟수", "산출", "자기효능감·문제해결력·의사소통 능력 향상", "직접입력", "", 4, 4, "상향", "회"],
    ["K2", "참여 청소년 수(실인원)", "산출", "자기효능감·문제해결력·의사소통 능력 향상", "직접입력", "", 64, 64, "상향", "명"],
    ["K3", "자기효능감 향상도", "단기성과", "자기효능감·문제해결력·의사소통 능력 향상", "사전사후 변화량", "자기효능감", 0.4, "", "상향", "점"],
    ["K4", "의사소통 능력 향상도", "단기성과", "자기효능감·문제해결력·의사소통 능력 향상", "사전사후 변화량", "의사소통 능력", 0.4, "", "상향", "점"],
...
// ───── 6) 7점 척도 + 역문항 + NPS ─────
{
  ...
  XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet([
    ["구분", "항목", "내용", "비고"],
    ["사업개요", "사업명", "2026 생태 탐험 캠프", ""],
    ["사업개요", "사업기간", "2026. 5. ~ 2026. 6. (당일 프로그램 × 8회)", ""],
    ["사업개요", "참여대상", "관내 초·중학생 80명", ""],
    ["사업개요", "사업예산", "6,500천원", ""],
    ["사업개요", "추진부서", "청소년환경교육팀", ""],
    ["사업개요", "추진배경", "청소년의 자연 체험 기회 감소와 환경 감수성 저하 우려", ""],
    ["사업개요", "사업목적", "생태 탐험 활동을 통해 청소년의 자연에 대한 흥미와 또래 협력 경험을 높인다", ""],
    ["목표", "추진목표", "활동 흥미도와 협력 경험 확대", ""],
    ["목표", "추진목표", "프로그램 추천 의향(NPS) 제고", ""],
    ["논리모형", "투입", "예산 6,500천원\n생태 해설사 4명\n인근 생태공원·수목원", ""],
    ["논리모형", "활동", "생태 탐사 8회\n모둠별 관찰일지 작성 8회", ""],
    ["논리모형", "산출", "프로그램 8회 운영\n참여 청소년 연인원 80명", ""],
    ["논리모형", "단기성과", "활동 흥미도 향상\n협력 기회 충분도 향상\n추천지수 제고", ""],
    ["논리모형", "중기성과", "환경에 대한 관심 지속", ""],
    ["논리모형", "영향", "자연과 공동체를 아끼는 청소년 성장", ""],
  ]), "사업정보");
  XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet([
    ["지표ID", "지표명", "성과단계", "연계목표", "측정방법", "대상문항", "목표값", "실적값", "방향", "단위"],
    ["K1", "프로그램 운영 횟수", "산출", "활동 흥미도와 협력 경험 확대", "직접입력", "", 8, 8, "상향", "회"],
    ["K2", "참여 청소년 수(실인원)", "산출", "활동 흥미도와 협력 경험 확대", "직접입력", "", 80, 80, "상향", "명"],
    ["K3", "활동 흥미도(100점 환산)", "단기성과", "활동 흥미도와 협력 경험 확대", "100점 환산", "활동 내용이 흥미로웠다", 80, "", "상향", "점"],
